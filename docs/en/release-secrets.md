...
| Edge Function `SKEINLY_DATABASE_WEBHOOK_SECRET` | `openssl rand -hex 32` for new value → re-register Supabase secret + update signing secret on each of the 3 Database Webhooks via Dashboard | Annual or on incident |
