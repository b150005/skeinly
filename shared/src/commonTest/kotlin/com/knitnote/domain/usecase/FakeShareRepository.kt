...
class FakeShareRepository : ShareRepository {
    ...
    override suspend fun updateStatus(id: String, status: ShareStatus): Share {
        val updated = shares.value.find { it.id == id }?.copy(status = status)
