...
class CompleteProjectUseCaseTest {
    ...
    @Test
    fun `complete IN_PROGRESS project sets status to COMPLETED`() =
        runTest {
    ...
    @Test
    fun `complete NOT_STARTED project sets status to COMPLETED`() =
        runTest {
    ...
    @Test
    fun `complete already COMPLETED project is no-op`() =
        runTest {
    ...
    @Test
    fun `complete preserves currentRow`() =
        runTest {
    ...
    @Test
    fun `complete updates updatedAt`() =
        runTest {
            repository.create(createProject())
    ...
    @Test
    fun `complete returns NotFound for missing project`() =
        runTest {
