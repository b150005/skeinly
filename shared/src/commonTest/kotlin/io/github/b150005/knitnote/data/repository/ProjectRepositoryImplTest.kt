...
class ProjectRepositoryImplTest {
    ...
    @Test
    fun `insert and retrieve project by id`() =
        runTest {
    ...
    @Test
    fun `retrieve by owner id returns projects ordered by created_at desc`() =
        runTest {
    ...
    @Test
    fun `update project current row`() =
        runTest {
            val project = createTestProject()
            repository.create(project)
    ...
    @Test
    fun `getByPatternId returns matching projects`() =
        runTest {
            val project = createTestProject()
            repository.create(project)
