...
class MergePullRequestUseCaseTest {
        ...
        runTest {
            val auth =
                FakeAuthRepository().apply {
                    setAuthState(
                        io.github.b150005.knitnote.domain.model.AuthState
    ...
    fun `applyResolutions auto-clean preserves target-side autoFromMine edits`() =
        runTest {
            ...
            val report =
                io.github.b150005.knitnote.domain.chart.ConflictDetector.detect(
                    ancestor = ancestor,
                    theirs = theirs,
                    mine = mine,
                )
        ...
        runTest {
            ...
            val resolved =
                applyResolutions(
                    ...
                    conflictPicks =
                        mapOf(
                            io.github.b150005.knitnote.domain.chart
                                .CellCoordinate("L2", 0, 0)
                                to ConflictResolution.SKIP,
                        ),
                    autoLayerFromTheirs =
                        listOf(
                            io.github.b150005.knitnote.domain.model.LayerChange.Removed(
