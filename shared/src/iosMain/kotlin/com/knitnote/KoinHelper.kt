...
fun wrapAuthState(flow: kotlinx.coroutines.flow.StateFlow<com.knitnote.ui.auth.AuthUiState>): FlowWrapper<com.knitnote.ui.auth.AuthUiState> =
    FlowWrapper(flow)

fun wrapProjectListState(flow: kotlinx.coroutines.flow.StateFlow<com.knitnote.ui.projectlist.ProjectListState>): FlowWrapper<com.knitnote.ui.projectlist.ProjectListState> =
    FlowWrapper(flow)

fun wrapProjectDetailState(flow: kotlinx.coroutines.flow.StateFlow<com.knitnote.ui.projectdetail.ProjectDetailState>): FlowWrapper<com.knitnote.ui.projectdetail.ProjectDetailState> =
    FlowWrapper(flow)

fun wrapProgressNotesState(flow: kotlinx.coroutines.flow.StateFlow<List<com.knitnote.domain.model.Progress>>): FlowWrapper<List<com.knitnote.domain.model.Progress>> =
    FlowWrapper(flow)

fun wrapProfileState(flow: kotlinx.coroutines.flow.StateFlow<com.knitnote.ui.profile.ProfileState>): FlowWrapper<com.knitnote.ui.profile.ProfileState> =
    FlowWrapper(flow)

fun wrapActivityFeedState(flow: kotlinx.coroutines.flow.StateFlow<com.knitnote.ui.activityfeed.ActivityFeedState>): FlowWrapper<com.knitnote.ui.activityfeed.ActivityFeedState> =
    FlowWrapper(flow)

fun wrapSharedWithMeState(flow: kotlinx.coroutines.flow.StateFlow<com.knitnote.ui.sharedwithme.SharedWithMeState>): FlowWrapper<com.knitnote.ui.sharedwithme.SharedWithMeState> =
    FlowWrapper(flow)

fun wrapSharedContentState(flow: kotlinx.coroutines.flow.StateFlow<com.knitnote.ui.sharedcontent.SharedContentState>): FlowWrapper<com.knitnote.ui.sharedcontent.SharedContentState> =
    FlowWrapper(flow)

fun wrapCommentSectionState(flow: kotlinx.coroutines.flow.StateFlow<com.knitnote.ui.comments.CommentSectionState>): FlowWrapper<com.knitnote.ui.comments.CommentSectionState> =
    FlowWrapper(flow)

fun wrapForkedProjectIdFlow(flow: kotlinx.coroutines.flow.Flow<String>): EventFlowWrapper<String> =
