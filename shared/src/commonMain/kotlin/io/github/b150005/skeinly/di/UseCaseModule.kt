...
import io.github.b150005.skeinly.domain.usecase.DeleteStructuredChartUseCase
...
import io.github.b150005.skeinly.domain.usecase.GetChartRevisionUseCase
    ...
    module {
        ...
        factory {
            MergePullRequestUseCase(
                mergeOperations = getOrNull<io.github.b150005.skeinly.domain.repository.PullRequestMergeOperations>(),
