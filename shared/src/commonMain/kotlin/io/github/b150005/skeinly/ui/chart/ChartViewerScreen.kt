    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        text = stringResource(Res.string.title_chart_viewer),
...
private fun androidx.compose.ui.graphics.drawscope.DrawScope.drawPolarRingLabels(
    polar: ChartExtents.Polar,
    layout: io.github.b150005.skeinly.domain.chart.PolarCellLayout.Layout,
    textMeasurer: androidx.compose.ui.text.TextMeasurer,
    color: Color,
) {
...
private fun androidx.compose.ui.graphics.drawscope.DrawScope.drawParameterSlots(
    def: io.github.b150005.skeinly.domain.symbol.SymbolDefinition,
    cell: ChartCell,
    bounds: Rect,
    cellSize: Float,
    textMeasurer: androidx.compose.ui.text.TextMeasurer,
