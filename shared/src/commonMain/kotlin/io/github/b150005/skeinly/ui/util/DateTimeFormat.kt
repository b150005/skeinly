...
/**
 * Formats an [Instant] as a compact "yyyyMMdd" date stamp in the given
 * [timeZone] — for filenames (e.g. the A20 data-export bundle
 * `skeinly-export-20260516.json`). Filesystem-safe (digits only, no
 * separators).
 */
fun Instant.formatDateStamp(timeZone: TimeZone = TimeZone.currentSystemDefault()): String {
    val dt = toLocalDateTime(timeZone)
