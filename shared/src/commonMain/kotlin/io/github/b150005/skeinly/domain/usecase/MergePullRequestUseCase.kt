...
/**
 * Apply a [io.github.b150005.skeinly.domain.chart.ConflictReport]'s resolution
...
fun applyResolutions(
    ...
    for (change in autoLayerFromTheirs) {
        when (change) {
            is io.github.b150005.skeinly.domain.model.LayerChange.Added ->
                layersById[change.layer.id] = change.layer
            is io.github.b150005.skeinly.domain.model.LayerChange.Removed ->
                layersById.remove(change.layerId)
            is io.github.b150005.skeinly.domain.model.LayerChange.PropertyChanged ->
    ...
    for (change in autoFromTheirs) {
        ...
        when (change) {
            is io.github.b150005.skeinly.domain.model.CellChange.Added ->
                cells[change.cell.x to change.cell.y] = change.cell
            is io.github.b150005.skeinly.domain.model.CellChange.Removed ->
                cells.remove(change.cell.x to change.cell.y)
            is io.github.b150005.skeinly.domain.model.CellChange.Modified ->
