...
data class ChartCell(
     ...
     * Keys must match [io.github.b150005.skeinly.domain.symbol.ParameterSlot.key] of the
     * resolved [io.github.b150005.skeinly.domain.symbol.SymbolDefinition]; unknown keys
