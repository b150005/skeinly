...
class ProjectListScreenTest {
    ...
    @Test
    fun emptyState_displaysNoProjectsMessage() = runComposeUiTest {
        setContent {
            KnitNoteTheme {
    ...
    @Test
    fun fab_opensCreateDialog() = runComposeUiTest {
        setContent {
            KnitNoteTheme {
                ProjectListScreen(onProjectClick = {})
            }
    ...
    @Test
    fun createProject_appearsInList() = runComposeUiTest {
        setContent {
            KnitNoteTheme {
                ProjectListScreen(onProjectClick = {})
            }
    ...
    @Test
    fun projectWithProgress_displaysCorrectly() = runComposeUiTest {
        seedProject(
    ...
    @Test
    fun clickProject_callsCallback() = runComposeUiTest {
    ...
    @Test
    fun createDialog_cancelDismisses() = runComposeUiTest {
        setContent {
            KnitNoteTheme {
                ProjectListScreen(onProjectClick = {})
            }
