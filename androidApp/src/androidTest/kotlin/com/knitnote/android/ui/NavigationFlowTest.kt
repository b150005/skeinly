...
class NavigationFlowTest {
    ...
    @Test
    fun startDestination_isProjectList_inLocalOnlyMode() = runComposeUiTest {
        assumeLocalOnlyMode()
    ...
    @Test
    fun navigateToProfile_andBack() = runComposeUiTest {
        assumeLocalOnlyMode()
    ...
    @Test
    fun navigateToProjectDetail_andBack() = runComposeUiTest {
        assumeLocalOnlyMode()
    ...
    @Test
    fun navigateToActivityFeed_andBack() = runComposeUiTest {
        assumeLocalOnlyMode()
    ...
    @Test
    fun navigateToSharedWithMe_andBack() = runComposeUiTest {
        assumeLocalOnlyMode()
